...
IDSTRING(rcsid, "$Id: mob_prog.c,v 1.6 2003/09/18 10:37:26 dave Exp $");
 ...
 */
bool
mprog_seval(char *lhs, char *opr, char *rhs)
{
...
bool
mprog_veval(int lhs, char *opr, int rhs)
{
 ...
 */
int
mprog_do_ifchck(char *ifchck, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, CHAR_DATA *rndm)
{
    ...
    if (*point == '\0') {
        bugf("Mob: %d null ifchck", mob->pIndexData->vnum);
        return -1;
    }
    /* skip leading spaces */
    while (*point == ' ')
    ...
    while (*point != '(')
        if (*point == '\0') {
            bugf("Mob: %d ifchck syntax error", mob->pIndexData->vnum);
            return -1;
        }
        else if (*point == ' ')
            point++;
    ...
    *argpt = '\0';
    ...
    if (*point == '\0') {
        ...
        *val = '\0';
        ...
        while ((*point != ' ') && (!isalnum(*point)))
            if (*point == '\0') {
                bugf("Mob: %d ifchck operator without value", mob->pIndexData->vnum);
                return -1;
            }
            else
                *oprpt++ = *point++;
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'ispc'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isnpc'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isgood'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isfight'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isimmort'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'ischarmed'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isfollow'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'isaffected'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'hitprcnt'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'inroom'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'sex'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'position'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'level'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'class'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'r':
                if (rndm != NULL) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'goldamt'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'objtype'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'objval0'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'objval1'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'objval2'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'objval3'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj) {
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'number'", mob->pIndexData->vnum);
                return -1;
        }
    }
        ...
        switch (arg[1]) {        /* arg should be "$*" so just get the letter */
            ...
            case 'p':
                if (v_obj)
                    ...
                    return -1;
            default:
                bugf("Mob: %d bad argument to 'name'", mob->pIndexData->vnum);
                return -1;
        }
    }
     ...
     */
    bugf("Mob: %d unknown ifchck", mob->pIndexData->vnum);
    return -1;
 ...
 */
char               *
mprog_process_if(char *ifchck, char *com_list, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, CHAR_DATA *rndm)
{
    ...
    *null = '\0';
    ...
    while (loopdone == FALSE) {    /*scan over any existing or statements */
        ...
        while (*cmnd == ' ')
            cmnd++;
        if (*cmnd == '\0') {
            bugf("Mob: %d no commands after IF/OR", mob->pIndexData->vnum);
            return null;
        }
    ...
    if (flag)
        for (;;) {                /*ifcheck was true, do commands but ignore else to endif */
            ...
            if (!str_cmp(buf, "else")) {
                while (str_cmp(buf, "endif")) {
                    ...
                    while (*cmnd == ' ')
                        cmnd++;
                    if (*cmnd == '\0') {
                        bugf("Mob: %d missing endif after else", mob->pIndexData->vnum);
                        return null;
                    }
                    morebuf = one_argument(cmnd, buf);
                }
            ...
            while (*cmnd == ' ')
                cmnd++;
            if (*cmnd == '\0') {
                bugf("Mob: %d missing else or endif", mob->pIndexData->vnum);
                return null;
            }
            morebuf = one_argument(cmnd, buf);
        }
        ...
        while ((str_cmp(buf, "else")) && (str_cmp(buf, "endif"))) {
            ...
            while (*cmnd == ' ')
                cmnd++;
            if (*cmnd == '\0') {
                bugf("Mob: %d missing an else or endif", mob->pIndexData->vnum);
                return null;
            }
            morebuf = one_argument(cmnd, buf);
        }
        ...
        while (*cmnd == ' ')
            cmnd++;
        if (*cmnd == '\0') {
            bugf("Mob: %d missing endif", mob->pIndexData->vnum);
            return null;
        }
        morebuf = one_argument(cmnd, buf);
        ...
        for (;;) {                /*process the post-else commands until an endif is found. */
            ...
            if (!str_cmp(buf, "else")) {
                bugf("Mob: %d found else in an else section", mob->pIndexData->vnum);
                return null;
            }
            if (!str_cmp(buf, "break"))
                return null;
            ...
            while (*cmnd == ' ')
                cmnd++;
            if (*cmnd == '\0') {
                bugf("Mob:%d missing endif in else section", mob->pIndexData->vnum);
                return null;
            }
            morebuf = one_argument(cmnd, buf);
        }
 ...
 */
void
mprog_translate(char ch, char *t, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, CHAR_DATA *rndm)
{
    ...
    *t = '\0';
    switch (ch) {
        ...
        default:
            bugf("Mob: %d bad $var", mob->pIndexData->vnum);
            break;
    }
 ...
 */
void
mprog_process_cmnd(char *cmnd, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, CHAR_DATA *rndm)
{
    char                buf[MAX_INPUT_LENGTH];
 ...
 */
void
mprog_driver(char *com_list, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo)
{
 ...
 */
void
mprog_wordlist_check(char *arg, CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, int type)
{
...
void
mprog_percent_check(CHAR_DATA *mob, CHAR_DATA *actor, OBJ_DATA *obj, void *vo, int type)
{
    MPROG_DATA         *mprg;
 ...
 */
void
mprog_act_trigger(char *buf, CHAR_DATA *mob, CHAR_DATA *ch, OBJ_DATA *obj, void *vo)
{
    ...
    if (IS_NPC(mob)
        ...
        tmp_act->obj = obj;
        tmp_act->vo = vo;
        LINK(tmp_act, first_mpact, last_mpact, next, prev);
        mob->mpactnum++;
    }
    return;
...
void
mprog_death_trigger(CHAR_DATA *mob)
{
...
void
mprog_greet_trigger(CHAR_DATA *mob)
{
...
void
mprog_speech_trigger(char *txt, CHAR_DATA *mob)
{
